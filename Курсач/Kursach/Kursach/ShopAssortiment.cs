...
namespace Kursach
{
    public partial class ShopAssortiment : UserControl
    {
        ...
        private bool _isFavourite
        {
            ...
            set
            {
                if (value)
                {
                    panel2.BackgroundImage = Image.FromFile(@"..\..\Resources\FavouriteMiniChecked.png");
                }
                isFavourite = value;
            }
        }
        ...
        public ShopAssortiment(string gn, string pr, bool isbyed, bool isfavourite)
        {
            InitializeComponent();
            panel2.BackColor = Color.Transparent;
            SetRoundedShape(MainPanel, 10, true);
            SetRoundedShape(panel1, 10, false);
            _isBuied = isbyed;
        ...
        private void Panel2_MouseEnter(object sender, EventArgs e)
        {
            ...
            panel2.BackgroundImage = Image.FromFile(@"..\..\Resources\FavouriteMiniHov.png");
        }

        private void Panel2_MouseLeave(object sender, EventArgs e)
        {
            if (isFavourite) { return; }
            panel2.BackgroundImage = Image.FromFile(@"..\..\Resources\FavouriteMini.png");
        }
